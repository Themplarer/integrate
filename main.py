...
def main():
    ...
    parser.add_argument('-v', default='x',
                        help='Переменная интегрирования. Default - x')
    parser.add_argument('func',
                        help='Рациональная функция (отношение многочленов с '
                             'целыми коэффициентами от данной переменной). '
                             'Может содержать пробелы (однако, для этого нужно '
                             'заключить выражение в кавычки). Поддерживается '
                             'использование ** и ^ для обозначения возведения '
                             'в степень. Пример функции - '
                             '2x^2+5x**3 + (-8)x * x^2')
